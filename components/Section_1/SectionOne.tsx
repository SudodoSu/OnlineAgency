  ...
  return (
    <section className="h-screen w-full flex flex-col items-center">
      ...
      <div className="container flex flex-col gap-8 mt-[200px]">
        <h1 className="text-4xl lg:text-[64px] flex justify-center text-center">
      ...
      <div
        className="w-[80%]
        lg:w-[56rem]
        xl:w-[72rem] lg:px-32 pt-24"
      >
        <div className="flex gap-4 w-full h-[550px] m-auto bg-[#131415] rounded-[28px] p-8 relative left-0">
          <div className="w-full sm:w-1/3 bg-[#222228] rounded-[20px] p-4 flex items-center flex-col">
          ...
          <div className="hidden w-1/3 sm:flex gap-4 flex-col">
          ...
          <div className="w-1/3 hidden sm:flex flex-col gap-4">
